...
var _errorHandler = require("../decorators/error-handler");
...
var BaseService = (_class = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BaseService, [{
    ...
    key: "parseBody",
    value: function parseBody(req) {
      return (0, _bodyParser["default"])(req);
    }
  }]);
  return BaseService;
}(), ((0, _applyDecoratedDescriptor2["default"])(_class.prototype, "execute", [_errorHandler.ErrorHandler], Object.getOwnPropertyDescriptor(_class.prototype, "execute"), _class.prototype)), _class);
