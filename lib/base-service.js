...
var BaseService = /*#__PURE__*/function () {
  function BaseService(req, res) {
    ...
    this.response = {
      statusCode: _codes.StatusCode.OK,
      headers: {}
    };
  }
  ...
  (0, _createClass2["default"])(BaseService, [{
    ...
    value: function execute() {
      var serviceMethod = (0, _meta.getServiceMethod)(this);

      if (!this[serviceMethod]) {
        throw new _errors.ServiceError('Service Method Not Found', _codes.StatusCode.NOT_FOUND);
      }
    ...
    value: function getCurrentService(url) {
      var _iterator = _createForOfIteratorHelper(_meta.EndpointsByServiceMap.keys()),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if ((0, _meta.isProperlyService)(Service, url)) {
            return Service;
          }
        }
      } catch (err) {
