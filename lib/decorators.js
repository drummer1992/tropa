...
var _bodyParser = require("./utils/body-parser");

function Service(name) {
  return function (Clazz) {
    (0, _meta.setServiceRegExp)(Clazz, new RegExp("^".concat((0, _meta.getApiPrefix)()).concat(name === '/' ? '' : name)));
  };
}

function ApiPrefix(prefix) {
  (0, _meta.setApiPrefix)(prefix);
  return function (Clazz) {
    return Clazz;
  };
}
...
function Endpoint(method, pathOrOptions) {
  ...
  return function (instance, serviceMethod, descriptor) {
    var endpoint = descriptor.value;
    (0, _meta.addEndpoint)(instance.constructor, {
      method: method,
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return (0, _bodyParser.parseBody)(this._req);
